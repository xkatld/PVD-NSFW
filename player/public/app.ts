...
function setup_video_pitch(v: HTMLVideoElement) {
...
function render_videos() {
    ...
    video_items.forEach((video, index) => {
        ...
        const speed_btn = card.querySelector('.speed-ctrl') as HTMLElement;
        const progress_filled = card.querySelector('.progress-filled') as HTMLElement;
        const progress_container = card.querySelector('.progress-container') as HTMLElement;
        ...
        const update_progress = (e: MouseEvent | TouchEvent) => {
...
function update_video_resources(current_index: number) {
